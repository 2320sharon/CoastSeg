...
session_name = "sample_session_demo"
...
# -------------------------------------
# WARNING: This script requires the Pixi environment in segmentation_workflow.
# Before running, open segmentation_workflow and run: pixi install.
