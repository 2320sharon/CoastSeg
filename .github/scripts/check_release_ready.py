...
"Pre-release: build & install matrix" and "Pre-release: pixi solve" workflows):
...
def check_python_versions(config: dict, expected: list[str], report: Report) -> None:
    ...
    if supported == wanted:
        ...
        report.fail(
            ...
            "Update the matrix in .github/workflows/release_env_matrix.yml and\n"
            "pixi_solve_matrix.yml, or update requires-python.",
        )
