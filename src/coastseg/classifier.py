...
def move_matching_files(input_image_path: str, search_string: str, file_exts: List[str], target_dir: str) -> None:
    """
...
def sort_images_with_model(input_directory: str, type: str = 'rgb', threshold: float = 0.40) -> None:
    """
...
def define_RGB_image_classifier_model(input_shape: Tuple[int, int, int], num_classes: int = 2):
    """
...
def define_segmentation_classifier_model(input_shape: Tuple[int, int, int], num_classes: int = 2):
    """
